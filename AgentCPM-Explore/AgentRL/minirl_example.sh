...
accelerate launch \
    ...
    --strict_in_bound true \
    --skip_length_normalization true \
    --max_steps 1000 \
    --num_train_epochs 3 \
    --adv_scaling 2.0 \
    --max_tokens 131072 \
    --loss_calculater "MINIRL" \
    --max_trained_count 1 \
    ...
    --mcp_manager_url "<YOUR_MCP_MANAGER_URL>" \
    --db_connection_string "mongodb://<YOUR_DB_HOST>:<YOUR_DB_PORT>/$RUN_NAME?<YOUR_DB_OPTIONS>" \
    \
